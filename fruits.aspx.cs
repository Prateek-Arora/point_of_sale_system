...
public partial class fruits : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        string name = "apple";
        string query = "select stock from fruits where name='" + name  + "'";
        ...
        string name1 = "banana";
        string query1 = "select stock from fruits where name='" + name1 + "'";
        ...
        string name2 = "blue-berry";
        string query2 = "select stock from fruits where name='" + name2 + "'";
        ...
        string name3 = "strawberry";
        string query3 = "select stock from fruits where name='" + name3 + "'";
        ...
        string query4 = "select stock from fruits where name='" + name4 + "'";
        ...
        string name5 = "papaya";
        string query5 = "select stock from fruits where name='" + name5 + "'";
        ...
        string name6 = "kiwi";
        string query6 = "select stock from fruits where name='" + name6 + "'";
        ...
        string name7 = "watermelon";
        string query7 = "select stock from fruits where name='" + name7 + "'";
        ...
        string name8 = "melon";
        string query8 = "select stock from fruits where name='" + name8 + "'";
        ...
        string name9 = "grapes";
        string query9 = "select stock from fruits where name='" + name9 + "'";
        ...
        string name10 = "guava";
        string query10 = "select stock from fruits where name='" + name10 + "'";
        ...
        string name11 = "mango";
        string query11 = "select stock from fruits where name='" + name11 + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string query = "select price from fruits where name='" + name + "'";
        SqlCommand com = new SqlCommand(query, conn);
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox2.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox3.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox4.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox5.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox6.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
    ...
    protected void Button7_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox7.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox8.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
    ...
    protected void Button9_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox9.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
    ...
    protected void Button10_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox10.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
    ...
    protected void Button11_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox11.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
    ...
    protected void Button12_Click(object sender, EventArgs e)
    {
        ...
        if (temp == 1)
        {
            ...
            {
                string update = "update bill set Quantity='" + TextBox12.Text + "',Amount='" + amount + "' where Item_Name='" + name + "'";
                SqlCommand commm = new SqlCommand(update, conn);
                commm.ExecuteNonQuery();
            }
        }
