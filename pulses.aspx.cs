...
public partial class pulses : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["pos_string"].ConnectionString);
        conn.Open();
        string name = "bambara-beans";
        string query = "select stock from pulses where name='" + name + "'";
        ...
        string name1 = "black-eyes-peas";
        string query1 = "select stock from pulses where name='" + name1 + "'";
        ...
        string name2 = "brown-chickpeas";
        string query2 = "select stock from pulses where name='" + name2 + "'";
        ...
        string name3 = "chickpeas";
        string query3 = "select stock from pulses where name='" + name3 + "'";
        ...
        string name4 = "cow-beans";
        string query4 = "select stock from pulses where name='" + name4 + "'";
        ...
        string name5 = "fava-beans";
        string query5 = "select stock from pulses where name='" + name5 + "'";
        ...
        string name6 = "kidney-beans";
        string query6 = "select stock from pulses where name='" + name6 + "'";
        ...
        string name7 = "pigeon-pea";
        string query7 = "select stock from pulses where name='" + name7 + "'";
        ...
        string name8 = "red-lentils";
        string query8 = "select stock from pulses where name='" + name8 + "'";
        ...
        string name9 = "small-yellow-lentils";
        string query9 = "select stock from pulses where name='" + name9 + "'";
        ...
        string name10 = "whole-black-lentils";
        string query10 = "select stock from pulses where name='" + name10 + "'";
        ...
        string name11 = "whole-mung-beans";
        string query11 = "select stock from pulses where name='" + name11 + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string query = "select price from pulses where name='" + name + "'";
        SqlCommand com = new SqlCommand(query, conn);
    ...
    protected void Button10_Click(object sender, EventArgs e)
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["pos_string"].ConnectionString);
        conn.Open();
        string name = "small-yellow-lentils";
        string category = "pulses";
        string query = "select price from pulses where name='" + name + "'";
        SqlCommand com = new SqlCommand(query, conn);
        int price = Convert.ToInt32(com.ExecuteScalar().ToString());
    ...
    protected void Button11_Click(object sender, EventArgs e)
    {
        SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["pos_string"].ConnectionString);
        conn.Open();
        string name = "whole-black-lentils";
        string category = "pulses";
        string query = "select price from pulses where name='" + name + "'";
        SqlCommand com = new SqlCommand(query, conn);
        int price = Convert.ToInt32(com.ExecuteScalar().ToString());
