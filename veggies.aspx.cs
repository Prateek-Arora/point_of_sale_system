...
public partial class veggies : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        conn.Open();
        string name = "cabbage";
        string query = "select stock from veggies where name='" + name + "'";
        ...
        string name1 = "carrot";
        string query1 = "select stock from veggies where name='" + name1 + "'";
        ...
        string name2 = "cauliflower";
        string query2 = "select stock from veggies where name='" + name2 + "'";
        ...
        string name3 = "eggplant";
        string query3 = "select stock from veggies where name='" + name3 + "'";
        ...
        string name4 = "green-capsicum";
        string query4 = "select stock from veggies where name='" + name4 + "'";
        ...
        string name5 = "onion";
        string query5 = "select stock from veggies where name='" + name5 + "'";
        ...
        string name6 = "potato";
        string query6 = "select stock from veggies where name='" + name6 + "'";
        ...
        string name7 = "pumpkin";
        string query7 = "select stock from veggies where name='" + name7 + "'";
        ...
        string name8 = "raddish";
        string query8 = "select stock from veggies where name='" + name8 + "'";
        ...
        string name9 = "red-capsicum";
        string query9 = "select stock from veggies where name='" + name9 + "'";
        ...
        string name10 = "spinach";
        string query10 = "select stock from veggies where name='" + name10 + "'";
        ...
        string name11 = "tomato";
        string query11 = "select stock from veggies where name='" + name11 + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string query = "select price from veggies where name='" + name + "'";
        SqlCommand com = new SqlCommand(query, conn);
